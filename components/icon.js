export default function Icon({ name = "grid", size = 20 }) {
  const paths = {
    ...
    "eye-off": "M3 3l18 18 M10.6 5.1A12 12 0 0 1 12 5c6.5 0 10 7 10 7a18 18 0 0 1-3.1 3.9 M6.1 6.1A21 21 0 0 0 2 12s3.5 7 10 7a12 12 0 0 0 5.9-1.6 M9.9 9.9a3 3 0 0 0 4.2 4.2",
